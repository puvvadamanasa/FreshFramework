...
public class RegisterPage {
	...
	public boolean registerUser(String firstName,String lastName,String email,String telephone,String password,String subscribe) {
		...
		String succMsg = eleUtil.waitForElementVisible(registerSuccessMesg, AppConstants.DEFAULT_MEDIUM_TIME_OUT).getText();
		if(succMsg.contains(AppConstants.USER_REG_SUCC_MSG)) {
